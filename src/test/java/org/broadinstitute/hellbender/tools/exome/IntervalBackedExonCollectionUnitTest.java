...
public final class IntervalBackedExonCollectionUnitTest extends BaseTest {
    ...
    public void setUp() {
        ...
        Collections.sort(nonOverlappingExomeIntervals,((Comparator<SimpleInterval>)(a,b) -> a.getContig().compareTo(b.getContig())).thenComparing((a,b) -> Integer.compare(a.getStart(),b.getStart())));
    }
    ...
    public void testCorrectInitializationSortingContigsByName() {
        final List<SimpleInterval> sortedLexicographically = nonOverlappingExomeIntervals.stream()
                .sorted(((Comparator<SimpleInterval>) (a, b) -> a.getContig().compareTo(b.getContig())).thenComparing(
                        (a, b) -> {
    ...
    public void testCorrectInitializationUnsorted() {
        ...
        final Comparator<SimpleInterval> intervalComparator = ExomeToolsTestUtils.createIntervalComparator();
        ...
        OUTER_LOOP: for (int i = 0; i < unsortedIntervals.size(); i++) {
            ...
            for (int j = i + 1; j < unsortedIntervals.size(); j++) {
                ...
                if (intervalComparator.compare(iInterval,jInterval) > 0) {
    ...
    public void testIncorrectInitialization6() {
        ...
        intervals.add(1, new SimpleInterval(interval.getContig(),interval.getEnd(),interval.getEnd()));
        new IntervalBackedExonCollection(intervals);
    }
